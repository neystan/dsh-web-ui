/**
 * Package-owned invariant companion for `@neystan/dsh-client-ui-git-graph`.
 ...
 * @module @neystan/dsh-client-ui-git-graph/invariant
 */
...
const PACKAGE_NAME = '@neystan/dsh-client-ui-git-graph'
