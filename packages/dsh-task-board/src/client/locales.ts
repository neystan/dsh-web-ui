...
export const zh = {
  ...
  'todo.title': '待办事项',
  'todo.add': '添加待办',
  'todo.addPlaceholder': '记一件要做的事…',
  'todo.empty': '还没有待办，记一件吧',
  'todo.done': '已完成',
  'todo.open': '待处理',
  'new.title': '标题',
  ...
  'detail.workspace': '执行工作区',
  'detail.workspacePlaceholder': '任务执行目录（留空使用 cron 工作区）',
  'detail.workspaceHint': '任务执行会话的工作目录；留空时使用自动创建的 cron 工作区（~/.dsh/cron-workspace）。每个任务固定占用一个会话，会话标题为任务名。',
  'detail.schedule.invalid': 'Cron 表达式无效',
  'detail.schedule.notScheduled': '尚未排程',
  'detail.schedule.dueSoon': '即将运行',
  'detail.schedule.mode': '模式',
  'detail.schedule.mode.recurring': '周期',
  'detail.schedule.mode.once': '一次性',
  'detail.schedule.onceAt': '触发时间',
  'detail.schedule.onceAtPlaceholder': '选择本地时间',
  'detail.schedule.onceInvalid': '请选择有效的触发时间',
  'detail.schedule.onceFired': '已触发，等待本次执行完成',
  'detail.schedule.onceHint': '一次性任务在触发时刻执行一次，执行完成后任务自动删除。',
  'card.scheduled': '定时',
  'card.oneShot': '一次性',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'todo.title': 'Todos',
  'todo.add': 'Add todo',
  'todo.addPlaceholder': 'Something to do…',
  'todo.empty': 'No todos yet — write one down',
  'todo.done': 'Done',
  'todo.open': 'Open',
  'new.title': 'Title',
  ...
  'detail.workspacePlaceholder': 'Task working directory (blank = cron workspace)',
  'detail.workspaceHint': 'The working directory of the task execution session; blank uses the auto-created cron workspace (~/.dsh/cron-workspace). Each task owns one fixed session titled after the task.',
  ...
  'detail.schedule.mode.recurring': 'Recurring',
  'detail.schedule.mode.once': 'One-shot',
  'detail.schedule.onceAt': 'Trigger time',
  'detail.schedule.onceAtPlaceholder': 'Pick a local time',
  'detail.schedule.onceInvalid': 'Pick a valid trigger time',
  'detail.schedule.onceFired': 'Fired — waiting for the run to settle',
  'detail.schedule.onceHint': 'A one-shot task runs once at the trigger instant and is removed once the run settles.',
