window.__ModuleLoader__.load({
	id: "@neystan/dsh-client-ui-skin-trading",
	factory: (require) => {
		var module = { exports: {} };
		...
		const tagId = "@neystan/dsh-client-ui-skin-trading/trading.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@neystan/dsh-client-ui-skin-trading";
