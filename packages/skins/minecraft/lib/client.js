window.__ModuleLoader__.load({
	id: "@neystan/dsh-client-ui-skin-minecraft",
	factory: (require) => {
		var module = { exports: {} };
		...
		const tagId = "@neystan/dsh-client-ui-skin-minecraft/minecraft.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@neystan/dsh-client-ui-skin-minecraft";
